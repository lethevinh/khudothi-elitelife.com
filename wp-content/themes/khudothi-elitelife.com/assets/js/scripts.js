(function($) {
    ...
    jQuery(document).on('ready', function() {
        ...
        let carousel_portfolio = $(".owl-carousel-portfolio");
        if(carousel_portfolio.length > 0){
            carousel_portfolio.each(function (i,carousel){
                carousel = $(carousel);
                let prev = carousel.data('icon-prev');
                prev = prev ? prev : 'prev.png';
                let next = carousel.data('icon-next');
                ...
                carousel.owlCarousel({
                    ...
                    autoPlay: false,
                    nav: true,
                    navigationText: ["<img src='"+themeUrl+"/assets/images/"+prev+"'>", "<img src='"+themeUrl+"/assets/images/"+next+"'>"]
                });
            });
        }
